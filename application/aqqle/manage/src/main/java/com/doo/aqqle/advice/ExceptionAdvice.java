...
public class ExceptionAdvice {
    ...
    @ExceptionHandler(CApiFailException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    protected CommonResult apiFailException(HttpServletRequest request, CApiFailException e) {
        System.out.println("msg 22: " + e.getMessage());
        return responseService.getFailResult(Integer.valueOf(getMessage("apiFail.code")), getMessage("apiFail.msg"));
    }
