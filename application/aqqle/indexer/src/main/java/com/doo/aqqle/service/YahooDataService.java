...
public class YahooDataService {
    ...
    private final YahooAsyncTaskService asyncTaskService;
    ...
    public void index(String type) {
        ...
        String indexName = ElasticStatic.YAHOO.getAlias() + "-" + LocalDateTime.now().format(dateTimeFormatter).toString();

        try {
//            DeleteIndexRequest deleteIndexRequest = new DeleteIndexRequest(indexName);
//            client.indices().delete(deleteIndexRequest, RequestOptions.DEFAULT);

            String setting = getResourceData("yahoo_setting.json");
            String mapping = getResourceData("yahoo_mapping.json");
            ...
            IndicesAliasesRequest.AliasActions aliasActionsAdd = new IndicesAliasesRequest.AliasActions(IndicesAliasesRequest.AliasActions.Type.ADD)
                    .index(indexName)
                    .alias(ElasticStatic.YAHOO.getAlias());
